...
def main():
    ...
    parser.add_argument(
        ...
        default=0.0,
        help=(
            "Keep up to this many GiB of repeatedly streamed target components resident. "
            "The default remains fully streamed for low-memory Macs."
        ),
    )
    parser.add_argument(
        "--no-final-reference",
    ...
    if args.resident_gib < 0:
        raise ValueError("--resident-gib must be >= 0")
